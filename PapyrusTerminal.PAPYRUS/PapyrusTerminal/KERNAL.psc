...
Event OnPapyrusTerminalShutdown()
	; must override in derived class
	Debug.Trace(Self + ": ERROR - OnPapyrusTerminalShutdown() called on BIOS class. This happens in error and the terminal script won't work. Your script must extend the BIOS class instead.")
EndEvent
